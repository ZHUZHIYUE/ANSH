...
public static class DBContextOptionsExtensions
{
    ...
    public static IQueryable<TEntity> ToPage<TEntity>(this IQueryable<TEntity> iqueryable, out int datacount, out int pagecount, int page = 1, int pagesize = 20) where TEntity : DBEntity
    {
