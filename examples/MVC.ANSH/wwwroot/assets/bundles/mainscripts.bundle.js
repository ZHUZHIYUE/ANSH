...
function CustomPageJS() {
    $(".boxs-close").on("click",
        ...
        $(".minileftbar .notifications").on("click",
            function () {
        ...
        $(".minileftbar .menuapp-btn").on("click",
            function () {
        ...
        $(".minileftbar .js-right-sidebar").on("click",
            function () {
        ...
        $(".btn_overlay").on("click",
            function () {
                $(".overlay_menu").fadeToggle(200),
                    $(this).toggleClass("btn-open").toggleClass("btn-close")
            }),
        $(".overlay_menu .btn").on("click",
            function () {
                $(".overlay_menu").fadeToggle(200),
                ...
                $(".menu-toggle").on("click",
                    function (a) {
                        ...
                        if ($(b.parents("ul")[0]).hasClass("list")) {
                            ...
                            $.each($(".menu-toggle.toggled").not(d).next(),
                                function (a, b) {
