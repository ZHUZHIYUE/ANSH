            ...
            function (a) {
                ...
                l.VERSION = "1.12.4",
                    ...
                    l.prototype = {
                        ...
                        createLi: function () {
                            ...
                            return l.each(function (b) {
                                ...
                                if (g++ , !f.hasClass("bs-title-option")) {
                                    ...
                                    else if (!0 === f.data("hidden")) k = f.data("prevHiddenIndex"),
                                        f.next().data("prevHiddenIndex", void 0 !== k ? k : b),
                        ...
                        render: function (b) {
                            var c, d = this,
                                e = this.$element.find("option"); !1 !== b && e.each(function (a) {
                        ...
                        keydown: function (b) {
                            ...
                            if (!(f = i.$newElement.hasClass("open")) && (b.keyCode >= 48 && b.keyCode <= 57 || b.keyCode >= 96 && b.keyCode <= 105 || b.keyCode >= 65 && b.keyCode <= 90)) return i.options.container ? i.$button.trigger("click") : (i.setSize(), i.$menu.parent().addClass("open"), f = !0),
                ...
                return this.each(function () {
                    ...
                    if (u.parent().hasClass(d.wrapperClass)) {
                        ...
                        if (z = u.closest("." + d.barClass), y = u.closest("." + d.railClass), f(), a.isPlainObject(b)) {
                            ...
                            else if ("destroy" in b) return z.remove(),
                                y.remove(),
                                void u.unwrap();
                            e(v, !1, !0)
                        }
                        ...
                        y.css(A),
                            ...
                            u.parent().append(z),
                            u.parent().append(y),
                            d.railDraggable && z.bind("mousedown",
                                function (b) {
                                    var c = a(document);
                                    return k = !0,
            ...
            f = {
                request: function (b) {
                    ...
                    b = b || a.documentElement,
                        /5\.1[.\d]* Safari/.test(navigator.userAgent) ? b[e]() : b[e](c && Element.ALLOW_KEYBOARD_INPUT)
                },
                exit: function () {
                    a[d.exitFullscreen]()
                },
