...
namespace ANSH.DDD.Domain.Repository.EFCore {
    ...
    public interface IANSHEFCoreAggregateRootRepository<TAggregateRoot, TPKey> : IANSHEFCoreRepository<TAggregateRoot, TPKey>, IANSHAggregateRootRepository<TAggregateRoot, TPKey>
